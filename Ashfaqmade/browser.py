...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("Made by Ashfaq"))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About AshfaqBrowser", self)
        about_action.setStatusTip("Find out more about the AshfaqBrowser")  
        ...
        self.setWindowTitle("AshfaqBrowser")
    ...
    def add_new_tab(self, qurl=None, label="New Tab"):
        ...
        #We only want to update the url when it's from the
        # correct tab
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - AshfaqBrowser" % title)
...
app.setApplicationName("AshfaqBrowser")
app.setOrganizationName("Ashfaq")
